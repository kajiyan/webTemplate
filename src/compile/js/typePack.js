...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery, Backbone, _) {var __hasProp = {}.hasOwnProperty,
	  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
	
	__webpack_require__(6);
	
	window.SETTING = __webpack_require__(9);
	...
	(function(window, document, $) {
	  ...
	  __webpack_require__(2)(sn, $, Backbone, _);
	  return $(function() {
	    ...
	    sn.tf.setup(function() {
	      return $.when(sn.router.setup()).then((function(_this) {
	        return function() {
	          return console.log("- SETUP APP -");
	        };
	      })(this));
	    });
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(10), __webpack_require__(4), __webpack_require__(5)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(window, document, $) {
	  ...
	  return $.TypeFrameWork = sn.TypeFrameWork;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(sn, $, Backbone, _) {
	  return sn.Router = (function(_super) {
	    ...
	    Router.prototype.request = function(param) {
	      ...
	      return this.options.pages[param].setup(true);
	    };
	
	    Router.prototype.popup = function(param) {};
	
	    Router.prototype._events = function() {};
	
	    Router.prototype._getElements = function() {
	      this.$els = {};
	      return this.$els;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(jQuery) {module.exports = function(window, document, $) {
	  ...
	  __webpack_require__(11)(window);
	  return __webpack_require__(12)(window, document, $);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(5), __webpack_require__(10), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (function(window){
	  ...
	  if (setting.MODE === "PRODUCTION") {
	    setConsole();
	    setting.BASE_URL = "http://localhost/";
	    setting.BASE_PATH = "";
	...
	module.exports = function(window, document, $) {
	  ...
	  sn.TypeThread = (function(_super) {
	    ...
	    TypeThread.prototype.update = function(method) {
	      ...
	      this.lastTime = window.getTime();
	      currentFrame = Math.floor((this.lastTime - this.startTime) / (1000.0 / this.optiosn.frameRate) % 2);
	      if (currentFrame !== this.oldFrame) {
	        method();
	        if (this._draw != null) {
	          this._draw();
